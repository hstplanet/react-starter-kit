        ...
        <QKeyboardScreen>
            <View style={[styles.container, { justifyContent: "space-between" }]}>
                ...
                <View style={styles.innerContainer}>
                    ...
                    <Text style={{ fontSize: 22, marginVertical: 10, fontFamily: 'Lato-Regular' }}>Yeni şifrenizi girerek onaylayınız.</Text>
                    ...
                    <TextInput
                        ...
                        value={password}
                    />
                    <Text style={{ marginVertical: 4 }}>Onay</Text>
                    <TextInput
                        style={styles.input}
                    ...
                    <TouchableOpacity style={[styles.btn, { backgroundColor: color.primary, marginVertical: 10 }]} onPress={() => resetPassword()}>
                        <Text style={{ color: "#fff" }}>Şifremi Değiştir</Text>
                    </TouchableOpacity>
                </View>
